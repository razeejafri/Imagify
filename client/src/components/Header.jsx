...
export default function Header() {
  ...
  return (
    ...
    text-center my-20'>
        ...
        animate={{ opacity: 1}}
        >Turn text to <span 
        className='text-blue-500'>image</span>, in seconds</motion.h1>
        ...
        <motion.button onClick={ onClickHandler } className='sm:text-lg 
        text-white bg-black w-auto mt-8 px-12 py-2.5 flex 
        ...
        className=' flex flex-wrap justify-center gap-3 mt-16 '>
            ...
            (
                ...
                width={70} className='rounded hover:scale-105 transition-all duration-300 
