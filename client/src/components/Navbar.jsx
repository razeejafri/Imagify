    ...
    <div>
        {
            ...
            <div className='flex items-center gap-2 sm:gap-3'>
              ...
              px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                ...
                text-gray-600'>Credits left : {credit ?? 0}</p>
              </button>
            ...
            <div className='flex items-center gap-2 sm:gap-5'>
                <p onClick={()=>navigate('/buy')} className='cursor-pointer z-10'>
                Pricing</p>
                <button onClick={()=>setshowLogin(true)} className='bg-zinc-800 
                text-white px-7 py-2 sm:px-10 z-10 text-sm rounded-full'>Login</button>
            </div>
